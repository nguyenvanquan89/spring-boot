...
public class MessageKeys {
  ...
  public static final String ADD_NEW_SUCCESS = "msg.addnew.success";
  ...
  public static final String JWT_SIGNATURE_NOT_MATCH = "msg.jwt.signature.not.match";
  public static final String JWT_USERNAME_PASSWORD_WRONG = "errors.jwt.username.password.wrong";
  public static final String JWT_USERNAME_DISABLED = "errors.jwt.username.disabled";
  public static final String EMPTY_RESULT_DATA_ACCESS = "errors.empty.result.data.access";
  public static final String JSON_PARSE_ERROR = "errors.json.parse";
